...
const AddProjectInOrg = ({ open, handleClose, organisationId }) => {
    ...
    const addProjectInOrg = useMutation(
        (data) => {
            return axios.post(
                `${import.meta.env.VITE_API}/route/project/add-project/${organisationId}`,
                data,
                {
                    headers: {
...
export default AddProjectInOrg;
