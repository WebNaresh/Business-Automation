                    ...
                    {!isLoading && deptList && deptList?.length === 0 ? (
                        ...
                        <div className="w-full m-auto h-full">
                            <div className="flex flex-col gap-4 p-6">
                                ...
                                <Grid
                                    container
                                    spacing={3} // Increased space between grid items
                                    sx={{
                                        padding: "16px",
                                        boxShadow: "0px 4px 20px rgba(0, 0, 0, 0.05)",
                                        borderRadius: "16px",
                                        backgroundColor: "#ffffff", // White background for the container
                                        border: "1px solid #e5e7eb", // Light greyish border for the entire grid container
                                    }}
                                >
                                    {deptList &&
                                        deptList.departments?.map((department, id) => (
                                            <Grid
                                                item
                                                key={id}
                                                xs={12}
                                                sm={6}
                                                md={4} // 3 columns for medium screens and above
                                                sx={{
                                                    padding: "16px",
                                                    boxShadow: "0px 2px 10px rgba(0, 0, 0, 0.1)", // Subtle shadow for the card
                                                    borderRadius: "12px",
                                                    border: "1px solid #d1d5db", // Grey border for each grid item
                                                ...
                                                <Box>
                                                    <Typography
                                                        ...
                                                        sx={{
                                                            fontSize: "1rem",
                                                            fontWeight: 600,
                                                            color: "#1f2937", // Dark greyish color for text
                                                            marginBottom: "8px",
                                                        }}
                                                    >
                                                    ...
                                                    <Typography
                                                        variant="body2"
                                                        sx={{ color: "#4b5563", marginBottom: "4px" }} // Muted greyish text for details
                                                    >
                                                        <strong>Employees:</strong> {department?.employeeCount || 0}
                                                    </Typography>
                                                    <Typography
                                                        variant="body2"
                                                        sx={{ color: "#4b5563", marginBottom: "16px" }}
                                                    >
                                                        <strong>Location:</strong>{" "}
                                                        {department?.departmentLocation?.city || "N/A"}
                                                    </Typography>
                                                    <CardActions sx={{ paddingLeft: 2 }}>
                                                        <Box sx={{ display: "flex", gap: 2 }}>
                                                            <IconButton
                                                                ...
                                                                sx={{
                                                                    backgroundColor: "#f9fafb", // Light greyish for icon button
                                                                    "&:hover": { backgroundColor: "#e5e7eb" },
                                                                }}
                                                                size="small"
                                                            >
                                                                <VisibilityIcon
                                                                    sx={{ fontSize: "1.25rem", color: "#3b82f6" }} // Soft blue for icon
                                                                />
                                                            </IconButton>
                                                            <IconButton
                                                            ...
                                                            >
                                                                <EditIcon
                                                                    sx={{ fontSize: "1.25rem", color: "#6366f1" }} // Slightly vibrant purple for edit
                                                                />
                                                            </IconButton>
                                                            <IconButton
                                                                ...
                                                                sx={{
                                                                    backgroundColor: "#f9fafb",
                                                                    "&:hover": { backgroundColor: "#fee2e2" }, // Soft red hover effect
                                                                }}
                                                                size="small"
                                                            >
                                                                <DeleteIcon
                                                                    sx={{ fontSize: "1.25rem", color: "#ef4444" }} // Bright red for delete
                                                                />
                                                            </IconButton>
                                                        </Box>
                                                    </CardActions>
...
export default DisplayCardDept;
