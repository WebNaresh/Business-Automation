...
const {
    addCashIn, addCashOut,  getById, getSummary , getDataPersonalOfficial , getDataByTimePeriod , 
    dataDeleteById , updateDataById
...
router.route("/get/get-all-data/:organizationId").get(auth, getDataByTimePeriod);
router.route("/get/get-data-personal-official").get(auth, getDataPersonalOfficial);
